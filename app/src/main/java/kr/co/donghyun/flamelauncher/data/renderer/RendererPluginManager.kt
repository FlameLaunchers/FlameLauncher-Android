...
object RendererPluginManager {
    ...
    /**
     * 렌더러 id 로 감지된 외부 플러그인을 조회한다.
     * 내부 번들 렌더러(zink/gl4es/krypton)나 미설치면 null.
     * 현재 외부 플러그인은 MobileGlues 뿐이다.
     */
    fun pluginFor(rendererId: String?): RendererPlugin? = when (rendererId) {
